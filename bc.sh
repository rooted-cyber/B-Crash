...
printf " \e[1;96m v 2.0 Coding by https://github.com/thelinuxchoice\e[0m \n"|lolcat
echo
...
command -v php > /dev/null 2>&1 || { echo >&2 "bc needed php"; exit 1; }
...
printf "\n"
printf "\e[1;92m[~]\e[95m Press Enter to start B-Crash\n"
...
subdomain_resp=true
printf '\e[1;33m[\e[0m\e[1;77m+\e[0m\e[1;33m] Subdomain: (Default:\e[0m\e[1;77m bcrash123\e[0m\e[1;33m): \e[0m' $default_subdomain
read subdomain
